...
export class ReleaseService extends ReadFeatureService {
  ...
  readonly views = [
    { label: 'All', path: '/api/releases' },
    { label: 'Pending Confirmation', path: '/api/releases/pending' },
    { label: 'Confirmed', path: '/api/releases/confirmed' },
    { label: 'Not Announced', path: '/api/releases/not-announced' },
  ];
}
